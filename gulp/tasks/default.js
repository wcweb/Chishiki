...
// TODO can't kill directly.
gulp.task('minify', ['production:hbs'],function(){
...
gulp.task('production:server', ['bowerfiles:copy','production:hbs','less','minify','minify:css','production:nodemon']);
