            ...
            function (done) {
                ...
                user.save(function (err) {
                    ...
                    article = new Article({
                        ...
                        videos: [
                            { title: " HD",
                                link: '<iframe height=498 width=510 src="http://player.youku.com/embed/XNjcwMDQwNjYw" frameborder=0 allowfullscreen></iframe>'},
                    ...
                    if (count % 3 == 0){
                        article.image = {
                            cdnUri:'/tmp'+config.uploadImagesDirectory
                            ,files:['1397551139414.jpg']
                        };
                    }
                    if (count % 3 == 1) {
                        article.image = {cdnUri:'/tmp'+config.uploadImagesDirectory,
