...
var clients = require('../fixture/index').clients;
...
exports.initDatabase = function(callback){
    ...
    async.auto({
      ...
      initNodos: [ 'initQuizzes', function(cb,result){
       ...
       relationMap: [ 'initQuizzes', 'initUsers', 'initNodos', 'initCategories', 'initCourses',
          function(cb){
            async.auto({
              ...
              course_nodo: function(scb){
                courses.forEach(function(course, idx){
                  ...
                  nodos.forEach(function(nodo, idy){
                    if(idy!== num) course.nodos.push( {nodo:nodos[idy]});
                  })
                  course.save();
                })
                scb();
